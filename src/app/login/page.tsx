...
const MATRIX_MAX_COLUMNS = 72;
const MATRIX_TARGET_FPS = 15;

/** Canvas matrix rain — deferred after first paint, capped columns, no shadowBlur. */
function MatrixRain() {
  ...
  useEffect(() => {
    ...
    const syncLayout = () => {
      ...
      const rawColumns = Math.floor(canvas.width / fontSize);
      columnStep = Math.max(1, Math.ceil(rawColumns / MATRIX_MAX_COLUMNS));
      columns = Math.ceil(rawColumns / columnStep);
    ...
    const frameBudgetMs = 1000 / MATRIX_TARGET_FPS;
    let lastFrameAt = 0;
    let loopRaf = 0;
...
function LoginInner() {
  ...
  useEffect(() => {
    const guest = isParableDevGuestClientEnabled();
    setDevGuest(guest);
    if (guest) router.replace(nextPath);
  }, [nextPath, router]);
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-black text-white">
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-4 py-10">
        <div className="w-full max-w-[1100px] grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-6">
            <div className="relative login-hero-enter">
          ...
          <div className="lg:col-span-6 flex justify-center">
            <div className="relative w-full max-w-[560px] login-card-enter">
              {/* neon frame */}
              ...
              <div className="relative overflow-hidden rounded-[42px] border border-white/10 bg-white/[0.045] backdrop-blur-2xl shadow-[0_0_170px_rgba(0,242,254,0.16)]">
                ...
                <div className="relative p-8 sm:p-10">
                  ...
                  <div className="mt-10 space-y-6">
                    ...
                    {devGuest ? (
                      <div className="rounded-[20px] border border-[#00f2fe]/25 bg-[#00f2fe]/10 p-4 text-sm text-[#00f2fe]/90">
                        Local dev mode — no password. Opening the app…
                      </div>
                    ) : (
                      <div>
                        <div className="flex items-center justify-between">
                    ...
                    >
                      <span className="relative z-10">
                        {loading ? "Loading…" : devGuest ? "Continue" : "Log In"}
                      </span>
      ...
      <style jsx global>{`
        ...
        .login-hero-enter {
          animation: loginPanelEnter 0.45s cubic-bezier(0.2, 0.9, 0.2, 1) both;
        }
        .login-card-enter {
          animation: loginPanelEnter 0.5s cubic-bezier(0.2, 0.9, 0.2, 1) 0.04s both;
        }
