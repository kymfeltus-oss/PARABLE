  ...
  const wrapClass =
    layout === "mobile-rail"
      ...
      : layout === "mobile-drawer"
        ...
        : "pointer-events-auto absolute bottom-4 left-1/2 z-[55] flex max-w-[96vw] -translate-x-1/2 flex-wrap items-center justify-center gap-2 rounded-2xl border border-[#00f2fe]/25 bg-[#020406]/90 px-3 py-2.5 shadow-[0_12px_40px_rgba(0,0,0,0.55)] backdrop-blur-md sm:gap-2.5 sm:px-4";
