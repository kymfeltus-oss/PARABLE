...
import { Bell, Menu, MessageSquare, Search, Settings, User } from "lucide-react";
...
export default function KickTopNav({ query, onQueryChange, onMenuClick, onChatClick }: Props) {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 flex h-14 shrink-0 items-center gap-3 border-b border-[#24272c] bg-[#0b0e11]/95 px-3 backdrop-blur-md sm:px-4">
      <button
        type="button"
        onClick={onMenuClick}
