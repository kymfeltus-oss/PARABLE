 ...
 * Runs on instagram.com only — not inside the PARABLE app runtime.
 */
export const INSTAGRAM_COMMENTS_ACTIVITY_URL =
  "https://www.instagram.com/your_activity/interactions/comments";

export const INSTAGRAM_COMMENT_DELETION_SCRIPT = `;(async function () {
...
export const INSTAGRAM_COMMENT_DELETION_STEPS = [
  "Log in to Instagram on a desktop browser.",
  "Open Your Activity → Interactions → Comments.",
  "Open DevTools (Ctrl+Shift+J on Windows/Linux, Cmd+Option+J on Mac).",
  "Paste the copied script into the Console tab and press Enter.",
  "Watch the console for progress or errors. Stop the tab if behavior looks wrong.",
] as const;
